...
@section('title_for_layout','Sửa dạng bài tập')
@section('css')
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6">
							...
							<div class="preview-image mb-2">
								<img id="ImgPreview" src="{{ $detail->image }}" class="img-fluid avatar" alt="">
							</div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @else
                                            <input type="text" class="form-control" placeholder="Dạng bài tập" name="title" value="{{ $detail->title }}" >
                                        @endif
                                    </div>
                                </div>
