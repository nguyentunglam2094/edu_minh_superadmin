                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('code'))
                                            <input type="text" class="form-control is-invalid"  placeholder="Mã dạng bài tập" name="code" value="{{ old('code') }}"  >
                                            <div class="invalid-feedback">{{ $errors->first('code') }}</div>
                                        @else
                                            <input type="text" class="form-control" placeholder="Mã dạng bài tập" name="code" value="{{ old('code') }}" >
                                        @endif
                                    </div>
                                </div>
