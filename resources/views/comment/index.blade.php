...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title">Chi tiết bài tập</h3>
                    <h6 class="card-subtitle">{{ $detailEx->question }}</h6>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-6">
                            <div class="white-box text-center">
                                <img src="{{ asset($detailEx->image_question) }}" class="img-responsive">
                            </div>
                        </div>
                    </div>

                    <h6 class="card-subtitle">Lời giải</h6>
                    <div class="row">
                        @foreach (explode('|', $detailEx->image_answer) as $image)
                            <div class="col-lg-12 col-md-12 col-sm-6">
                                <div class="white-box text-center">
