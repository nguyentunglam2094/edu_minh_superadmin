        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="mt-4" method="POST" action="{{ route('update.test.type') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @if($errors->has('title'))
                                    <input type="text" class="form-control is-invalid"  placeholder="Loại đề thi" name="title" value="{{ $detail->title }}"  >
                                    <div class="invalid-feedback">{{ $errors->first('title') }}</div>
                                @else
                                    <input type="text" class="form-control" placeholder="Loại đề thi" name="title" value="{{  $detail->title  }}" >
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-6">
